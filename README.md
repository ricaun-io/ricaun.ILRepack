...
The package [ILRepack](https://github.com/gluck/il-repack) with version `2.0.45` is used by default to repack the assembly, if the your project contains a different version, the package will use the version from the package.
